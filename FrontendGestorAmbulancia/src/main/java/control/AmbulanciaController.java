...
public class AmbulanciaController {
    private final String apiUrl = "https://backendambulancia.onrender.com/vv/api/v1/registrarAmbulancia";
    private final String api2Url = "https://backendambulancia.onrender.com/vv/api/v1/listarAmbulancias";
...
// Declaración de variables
    ...
    public void registrarAmbulancia(AmbulanciaDTO ambulancia) {
        try {
            ...
            try (OutputStream outputStream = connection.getOutputStream()) {
                ...
                logger.log(Level.SEVERE, "Error al escribir en la conexión de salida", e);
            }
            ...
            logger.log(Level.SEVERE, "URL inválida", e);
    ...
    */
    public List<AmbulanciaDTO> consultarAmbulanciaPorPlaca(String numeroPlaca) {
        ...
        try {
            URL url = new URL(api2Url + "?placa=" + numeroPlaca);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
    ...
    */
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (placa.equalsIgnoreCase(numeroPlaca)) {
                        ...
                        if (actualizado) {
                            mostrarMensaje("Los datos de la ambulancia han sido actualizados correctamente.");
                            limpiarFormulario();
                        } else {
                            mostrarMensaje("No se pudo actualizar los datos de la ambulancia.");
                        }
    ...
    public boolean actualizarDatos(int id, String numeroPlaca, boolean estado, String tipo, String modelo, String observaciones) {
        try {
            String api3Url = "https://backendambulancia.onrender.com/vv/api/v1/modificarAmbulancia?id=" + id;

            URL url = new URL(api3Url);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
