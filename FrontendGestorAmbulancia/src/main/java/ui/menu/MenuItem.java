...
import view.ui.effect.RippleEffect;
import view.ui.swing.shadow.ShadowRenderer;
...
public class MenuItem extends JButton {
    ...
    public MenuItem(String name, int index, boolean subMenuAble) {
        ...
        rippleEffect.setRippleColor(new Color(100, 149, 237));
    }
    ...
    public void initSubMenu(int subMenuIndex, int length) {
        ...
        setBackground(new Color(32, 32, 50));
        setOpaque(true);
    }
